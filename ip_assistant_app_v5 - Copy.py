...
st.set_page_config(page_title="IP Assistant Prototype (v5)", layout="wide")
st.title("IP Assistant Prototype (v5)")
...
if (portfolio is not None) and filings_file:
    ...
    if len(alerts_df):
        ...
        with dl_col2:
            st.download_button("Download per-class Excel", data=excel_bytes, file_name="tm_watch_alerts_by_class.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
